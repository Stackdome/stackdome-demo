...
4. Write /opt/walkthrough/demos/walk.scenes.json and /opt/walkthrough/demos/walk.demo.ts. Take selectors from the app's source, not from guesses. Seed realistic data during setup, before startRecording.
